...
<body class="bg-hiking3">
  <section class="myActivity">
    ...
    <div class="w60 bg-blur p1em f12decrem centered mb2em">
      Vous avez dû faire une erreur... Ne vous en faîtes pas, ça peut arriver même aux meilleurs. La preuve ! Vous pouvez maintenant retenter votre chance en cliquant sur le bouton pour retourner à l'accueil. Bonne continuation !
    </div>
